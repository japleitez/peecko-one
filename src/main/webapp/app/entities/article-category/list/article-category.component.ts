...
export class ArticleCategoryComponent implements OnInit {
  ...
  trackId = (_index: number, item: IArticleCategory): number => this.articleCategoryService.getArticleCategoryIdentifier(item);
  ...
  delete(articleCategory: IArticleCategory): void {
    const modalRef = this.modalService.open(ArticleCategoryDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected fillComponentAttributesFromResponseBody(data: IArticleCategory[] | null): IArticleCategory[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.articleCategoryService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
