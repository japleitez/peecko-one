...
VIDEO_ACCESS = {
  ...
  tags: { listable: true, visible: true, disabled: false },
  player: { listable: true, visible: true, disabled: false },
  thumbnail: { listable: true, visible: true, disabled: false },
  url: { listable: true, visible: true, disabled: false },
  audience: { listable: true, visible: true, disabled: false },
  intensity: { listable: true, visible: true, disabled: false },
  filename: { listable: false, visible: true, disabled: false },
