...
export class CountryUpdateComponent implements OnInit {
  ...
  editForm: CountryFormGroup = this.countryFormService.createCountryFormGroup(undefined, this.getCountryAccess());
  ...
  save(): void {
    ...
    if (this.country) {
      this.subscribeToSaveResponse(this.countryService.update(country as ICountry));
    } else {
