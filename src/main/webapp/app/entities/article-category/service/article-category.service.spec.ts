...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../article-category.test-samples';

import { ArticleCategoryService, RestArticleCategory } from './article-category.service';

const requireRestSample: RestArticleCategory = {
  ...sampleWithRequiredData,
  created: sampleWithRequiredData.created?.toJSON(),
  release: sampleWithRequiredData.release?.toJSON(),
...
describe('ArticleCategory Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a ArticleCategory', () => {
      ...
      service.create(articleCategory).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ArticleCategory', () => {
      ...
      service.update(articleCategory).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addArticleCategoryToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(articleCategory);
        expect(expectedResult).toContain(articleCategory2);
      });
