...
const requireRestSample: RestInvoice = {
  ...
  issued: sampleWithRequiredData.issued?.toJSON(),
  dueDate: sampleWithRequiredData.dueDate?.format(DATE_FORMAT),
  saleDate: sampleWithRequiredData.saleDate?.format(DATE_FORMAT),
  paidDate: sampleWithRequiredData.paidDate?.format(DATE_FORMAT),
};
