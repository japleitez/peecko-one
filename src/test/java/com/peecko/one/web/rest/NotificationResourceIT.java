...
import com.peecko.one.domain.Notification;
import com.peecko.one.domain.enumeration.Language;
import com.peecko.one.repository.NotificationRepository;
...
class NotificationResourceIT {
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getVideoUrl()).isEqualTo(DEFAULT_VIDEO_URL);
        assertThat(testNotification.getStarts()).isEqualTo(DEFAULT_STARTS);
        assertThat(testNotification.getExpires()).isEqualTo(DEFAULT_EXPIRES);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        assertThat(testNotification.getVideoUrl()).isEqualTo(UPDATED_VIDEO_URL);
        assertThat(testNotification.getStarts()).isEqualTo(UPDATED_STARTS);
        assertThat(testNotification.getExpires()).isEqualTo(UPDATED_EXPIRES);
    }
