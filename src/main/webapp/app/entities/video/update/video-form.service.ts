...
export class VideoFormService {
  createVideoFormGroup(video: VideoFormGroupInput = { id: null }, ua: VideoAccess = VIDEO_ACCESS): VideoFormGroup {
    ...
    return new FormGroup<VideoFormGroupContent>({
      ...
      code: new FormControl({ value: videoRawValue.code, disabled: ua.code.disabled }, { validators: [Validators.required] }),
      title: new FormControl({ value: videoRawValue.title, disabled: ua.title.disabled }, { validators: [Validators.required] }),
      duration: new FormControl({ value: videoRawValue.duration, disabled: ua.duration.disabled }),
      language: new FormControl({ value: videoRawValue.language, disabled: ua.language.disabled }, { validators: [Validators.required] }),
      tags: new FormControl({ value: videoRawValue.tags, disabled: ua.tags.disabled }),
      player: new FormControl({ value: videoRawValue.player, disabled: ua.player.disabled }, { validators: [Validators.required] }),
