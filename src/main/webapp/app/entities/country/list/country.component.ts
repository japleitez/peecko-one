...
import { CountryArrayResponseType, CountryService } from '../service/country.service';
...
export class CountryComponent implements OnInit {
  ua: CountryAccess = this.getCountryAccess();
  countries?: ICountry[];
  isLoading = false;
  ...
  trackCode = (_index: number, item: ICountry): string => this.countryService.getCountryIdentifier(item);
  ...
  delete(country: ICountry): void {
    ...
    modalRef.closed
      ...
      .subscribe({
        next: (res: CountryArrayResponseType) => {
  ...
  protected loadFromBackendWithRouteInformations(): Observable<CountryArrayResponseType> {
  ...
  protected onResponseSuccess(response: CountryArrayResponseType): void {
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<CountryArrayResponseType> {
    this.isLoading = true;
  ...
  protected getCountryAccess(): CountryAccess {
